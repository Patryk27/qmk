...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ergodox_80(
        C(KC_TAB), KC_UP,   KC_BSPC, KC_UNDS, KC_NO, KC_NO, KC_NO,
        KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,  KC_T,  KC_BRIU,
        KC_BSPC,   KC_A,    KC_S,    KC_D,    KC_F,  KC_G,
        MT_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,  KC_B,  KC_BRID,
        KC_RALT,   C(KC_C), KC_NO,   KC_DOWN, LT_1,

                   KC_NO,      KC_MAIL,
        CK_VIM_SL, KC_NO,      KC_NO,
        LT_2,      S(KC_LCTL), RESET,

        KC_NO,       KC_NO, KC_SCLN, KC_MINS, KC_DEL,  KC_NO,      KC_NO,
        TD(TD_VOLU), KC_Y,  KC_U,    KC_I,    KC_O,    KC_P,       A(KC_X),
                     KC_H,  KC_J,    KC_K,    KC_L,    KC_QUOT,    CK_VIM,
        TD(TD_VOLD), KC_N,  KC_M,    KC_COMM, KC_DOT,  S(KC_SCLN), KC_NO,
                            LT_3,    KC_NO,   KC_NO,   KC_NO,      KC_NO,
    ...
    [1] = LAYOUT_ergodox_80(
        ...
        KC_NO, KC_BSLS,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
        ...
        KC_NO, KC_NO,       KC_LT, KC_SPC, KC_GT, KC_EXLM,        KC_NO,
    ...
    [2] = LAYOUT_ergodox_80(
        ...
        KC_NO,   KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
        KC_NO,   KC_NO, KC_PGUP, KC_HOME, KC_WH_U, KC_NO,
        KC_NO,   KC_NO, KC_PGDN, KC_END,  KC_WH_D, KC_NO, KC_NO,
    ...
    [3] = LAYOUT_ergodox_80(
        ...
        KC_NO, KC_NO, KC_NO,   KC_DLR,  KC_NO,   KC_NO, KC_NO,
        KC_NO, KC_NO, KC_AT,   KC_LBRC, KC_RBRC, KC_NO, KC_NO,
               KC_NO, KC_NO,   KC_LCBR, KC_RCBR, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_NO,
