...
Combo combos[COMBO_COUNT] = {
    ...
    { KC_QUOT, KC_W, KC_HOME },
    { KC_QUOT, KC_A, KC_PGUP },
    { KC_QUOT, KC_S, KC_END },
    { KC_QUOT, KC_D, KC_PGDN },
    ...
    { KC_DOT, KC_W, A(KC_UP) },
    { KC_DOT, KC_A, A(KC_LEFT) },
    { KC_DOT, KC_S, A(KC_DOWN) },
    { KC_DOT, KC_D, A(KC_RIGHT) },
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_ergodox_80(
        ...
        CK_TG_SFT, KC_UP, KC_DOWN, MT(4), LT(0),
